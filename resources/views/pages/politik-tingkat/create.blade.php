                        ...
                        <tbody>
                            @foreach ($jk as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="tidak_sekolah[]" value="0" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="sd[]" value="0" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="sltp[]" value="0" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="slta[]" value="0" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="pt[]" value="0" required>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
