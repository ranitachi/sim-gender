    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('politik-tingkat.store', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                        ...
                        <tbody>
                            @foreach ($jk as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="tidak_sekolah[]" value="123" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="sd[]" value="123" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="sltp[]" value="123" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="slta[]" value="123" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="pt[]" value="123" required>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
