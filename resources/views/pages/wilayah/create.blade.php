...
@section('title')
    <title>Form Tambah Data Luas Wilayah : Sistem Informasi Statistik Kabupaten Tangerang</title>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div style="padding:15px;">
                <form action="{{route('wilayah-luas-jlh-kecamatan.store',[$id_kategori,$tahun])}}" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($kecamatan as $item)
                                <tr>
                                    ...
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" name="luas_wilayah[{{$item->id}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" name="jumlah_desa[{{$item->id}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" name="jumlah_kelurahan[{{$item->id}}]" value="0"></td>
