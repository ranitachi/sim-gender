    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('rasio-murid-guru.store', array($kategori->id,$tahun)) }}" method="post">
                    @csrf
                            ...
                            @foreach ($jenjang as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control text-right" value="0" name="jumlah_murid[{{$key}}]">
                                    </td>
                                    <td class="text-center">
                                        <input type="text" class="form-control text-right" value="0" name="jumlah_guru[{{$key}}]">
                                    </td>
                                    <td class="text-center">
                                        <input type="text" class="form-control text-right" value="0" name="rasio[{{$key}}]">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
