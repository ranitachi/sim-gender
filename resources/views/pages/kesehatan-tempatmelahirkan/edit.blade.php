            ...
            <div class="content-group">
                <div class="page-header page-header-default" style="border: 1px solid #ddd; border-bottom: 0;">
                    ...
                    <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
                        ...
                        <a href="{{route('tempat-melahirkan.index',[$id_kategori,$tahun])}}" class="btn btn-xs btn-primary pull-right" style="margin-top:5px;"><i class="icon-arrow-left52"></i> Kembali</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('tempat-melahirkan.update', array($kategori->id,$tahun)) }}" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($krt as $idx => $val)
                                <tr>
                                    ...
                                    @foreach ($jenis as $idx_jen=>$item)
                                        <td class="text-center">
                                        <input type="text" class="form-control text-center" name="{{$idx}}[{{$idx_jen}}]" value="{{isset($data[$idx_jen][$idx]) ? number_format($data[$idx_jen][$idx],2,',','.') : 0}}">    
                                        </td>
                                    @endforeach
                                </tr>
                            @endforeach
