                ...
                <div class="page-header page-header-default" style="border: 1px solid #ddd; border-bottom: 0;">
                    ...
                    <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
                        <ul class="breadcrumb">
                            ...
                            <li><a href="{{route('pendidikan-ditamatkan.index',$kategori->id)}}">Pendidikan yang Ditamatkan</a></li>
    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('pendidikan-ditamatkan.update', array($kategori->id)) }}" method="post">
                    @csrf
                    @method('put')
                                ...
                                <tr>
                                    ...
                                    @foreach ($jjg as $idx_jg=>$jg)
                                        @php
                                            ...
                                            // $jlh=(isset($det[$item->id_kecamatan]) ? $det[$item->id_kecamatan][$idx_jg] : rand(0,90));
                                        @endphp
                                        <td>
                                            <input type="number" max="100" min="0" class="form-control text-center"     name="jumlah[{{$idx_jg}}][{{$item->id}}]" value="{{$jlh}}">
                                        </td>
                                    @endforeach
                                </tr>
                            @endforeach
