    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kependudukan-gelandangan.store', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                        ...
                        <tbody>
                            @foreach ($karakteristik as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="laki[]" value="0" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="perempuan[]" value="0" required>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
