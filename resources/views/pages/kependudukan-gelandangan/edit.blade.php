    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kependudukan-gelandangan.update', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    @method('put')
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="laki[]" value="{{ $item->laki }}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="perempuan[]" value="{{ $item->perempuan }}" required>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
