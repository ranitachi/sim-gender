    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kependudukan-susila.update', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    @method('put')
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min="0" class="form-control" name="susila_laki[]" value="{{ $item->susila_laki }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="susila_perempuan[]" value="{{ $item->susila_perempuan }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="napza_laki[]" value="{{ $item->napza_laki }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="napza_perempuan[]" value="{{ $item->napza_laki }}" required>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
