...
@section('title')
    <title>Form Tambah Data Angka Index IPM, IPG & IDG : Sistem Informasi Statistik Kabupaten Tangerang</title>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div style="padding:15px;">
                <form action="{{route('angka-index.store',[$id_kategori,$tahun])}}" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($kota as $item)
                                <tr>
                                    ...
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"   name="ipg[{{$item->id}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"   name="ipm[{{$item->id}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"   name="idg[{{$item->id}}]" value="0"></td>
                            ...
                            @endforeach
                                <tr>
                                    ...
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"   name="ipg[36]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"   name="ipm[36]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"   name="idg[36]" value="0"></td>                                    <td class="text-center">{{$tahun}}</td>
                                </tr>
                        </tbody>
                    </table>
                    <br>
