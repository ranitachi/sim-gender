    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kependudukan-sampling.store', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($karakteristik as $key => $item)
                                <tr>
                                    <td>{{ $key = $key + 1 }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="umur_4[]" value="123" required>
                                    </td>
                                    <td>
