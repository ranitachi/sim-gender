    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kependudukan-sampling.update', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    @method('put')
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>Karakteristik</th>
                                <th>Umur 0-4 Tahun</th>
                                <th>Umur 0-17 Tahun</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="umur_4[]" value="{{ $item->umur_4 }}" required>
                                    </td>
                                    <td>
