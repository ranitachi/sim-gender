    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('politik-kejadian.update', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    @method('put')
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min="0" class="form-control" name="rumah_tangga[]" value="{{ $item->rumah_tangga }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="tempat_kerja[]" value="{{ $item->tempat_kerja }}" required>
                                        </td>
                                        <td>
