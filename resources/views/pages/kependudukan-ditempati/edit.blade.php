    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kependudukan-ditempati.update', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    @method('put')
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="milik_sendiri[]" value="{{ $item->milik_sendiri }}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="kontrak[]" value="{{ $item->kontrak }}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="bebas_sewa[]" value="{{ $item->bebas_sewa }}" required>
                                    </td>
                                    <td>
