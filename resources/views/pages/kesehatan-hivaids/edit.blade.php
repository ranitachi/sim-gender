            ...
            <div class="content-group">
                <div class="page-header page-header-default" style="border: 1px solid #ddd; border-bottom: 0;">
                    ...
                    <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
                        ...
                        <a href="{{route('hiv-aids.index',[$id_kategori,$tahun])}}" class="btn btn-xs btn-primary pull-right" style="margin-top:5px;"><i class="icon-arrow-left52"></i> Kembali</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('hiv-aids.update', array($kategori->id,$tahun)) }}" method="post">
                    @csrf
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" rowspan="2">Kasus</th>
                                <th class="text-center" colspan="7">Tahun</th>
                            ...
                            <tr>
                                ...
                                @for ($i = (date('Y')-6); $i <= date('Y'); $i++)
                                    <td class="text-center"> 
                                        <input type="text" class="form-control text-center persen"  id="persentase_{{$x}}" name="persentase[{{$item}}][{{$i}}]" value="{{isset($data[$item][$i]['jumlah']) ? number_format($data[$item][$i]['jumlah'],0,',','.') : 0}}">    
                                    </td>
                                @endfor
                            </tr>
                            @php
