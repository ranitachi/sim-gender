    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('pendidikan-rasio.store', array($jenjang,$kategori->id)) }}" method="post">
                    @csrf
                        ...
                        <tbody>
                            @foreach ($kecamatan as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control text-center" name="jumlah_siswa[{{$jenjang}}][{{$item->id}}]" value="{{rand(10,10000)}}">
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control text-center" name="jumlah_sekolah[{{$jenjang}}][{{$item->id}}]" value="{{rand(10,100)}}">
                                    </td>
