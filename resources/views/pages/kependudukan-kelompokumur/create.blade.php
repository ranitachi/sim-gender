...
@section('title')
    <title>Form Tambah Data Kelompok Umur : Sistem Informasi Statistik Kabupaten Tangerang</title>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div style="padding:15px;">
                <form action="{{route('kelompok-umur.store',[$id_kategori,$tahun])}}" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($kelompok as $item)
                                <tr>
                                    ...
                                    <td class="text-center"><input type="text" class="form-control text-right" style="width:100px;" onkeyup="hitung({{$number}})" id="laki_laki_{{$number}}" name="laki_laki[{{$item}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" readonly id="persen_laki_laki_{{$number}}" name="persen_laki_laki[{{$item}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-right" style="width:100px;" onkeyup="hitung({{$number}})" id="perempuan_{{$number}}" name="perempuan[{{$item}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" readonly id="persen_perempuan_{{$number}}" name="persen_perempuan[{{$item}}]" value="0"></td>
