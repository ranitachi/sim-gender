    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('politik-korban.update', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    @method('put')
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="orang_tua[]" value="{{ $item->orang_tua }}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="keluarga[]" value="{{ $item->keluarga }}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="suami_istri[]" value="{{ $item->suami_istri }}" required>
                                    </td>
                                    <td>
