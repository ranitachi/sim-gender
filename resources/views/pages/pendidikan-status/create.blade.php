    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('status-pendidikan.store', array($kategori->id,$tahun)) }}" method="post">
                    @csrf
                            ...
                            <tr>
                                ...
                                @foreach ($status as $idx_jen=>$item)
                                    <td class="text-center">
                                        <input type="text" class="form-control text-center" name="laki_laki[{{$idx_jen}}]" value="0">    
                                    </td>
                                @endforeach
                            </tr>
                            <tr>
                                ...
                                @foreach ($status as $idx_jen=>$item)
                                    <td class="text-center">
                                        <input type="text" class="form-control text-center" name="perempuan[{{$idx_jen}}]" value="0">        
                                    </td>
                                @endforeach
                            </tr>
                            <tr>
