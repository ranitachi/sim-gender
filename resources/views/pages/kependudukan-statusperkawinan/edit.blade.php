...
@section('title')
    <title>Form Edit Data Status Perkawinan : Sistem Informasi Statistik Kabupaten Tangerang</title>
                ...
                <div class="page-header page-header-default" style="border: 1px solid #ddd; border-bottom: 0;">
                    ...
                    <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
                        <ul class="breadcrumb">
                            ...
                            <li><a href="{{route('status-perkawinan.index',[$id_kategori,$tahun])}}">Kependudukan</a></li>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div style="padding:15px;">
                <form action="{{route('status-perkawinan.update',[$id_kategori,$tahun])}}" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($kecamatan as $item)
                                <tr>
                                    ...
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" id="belum_kawin{{$number}}" name="belum_kawin[{{$item->id}}]" value="{{isset($data[$item->id]['belum_kawin']) ? $data[$item->id]['belum_kawin'] : 0}}"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" id="kawin{{$number}}" name="kawin[{{$item->id}}]" value="{{isset($data[$item->id]['kawin']) ? $data[$item->id]['kawin'] : 0}}"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"  id="cerai_hidup{{$number}}" name="cerai_hidup[{{$item->id}}]" value="{{isset($data[$item->id]['cerai_hidup']) ? $data[$item->id]['cerai_hidup'] : 0}}"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" name="cerai_mati[{{$item->id}}]" value="{{isset($data[$item->id]['cerai_mati']) ? $data[$item->id]['cerai_mati'] : 0}}"></td>
