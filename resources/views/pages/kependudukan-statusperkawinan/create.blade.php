...
@section('title')
    <title>Form Tambah Data Status Perkawinan : Sistem Informasi Statistik Kabupaten Tangerang</title>
            ...
            <div class="content-group">
                <div class="page-header page-header-default" style="border: 1px solid #ddd; border-bottom: 0;">
                    ...
                    <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
                        ...
                        <a href="{{route('status-perkawinan.index',[$id_kategori,$tahun])}}" class="btn btn-xs btn-primary pull-right" style="margin-top:5px;"><i class="icon-arrow-left52"></i> Kembali</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div style="padding:15px;">
                <form action="{{route('status-perkawinan.store',[$id_kategori,$tahun])}}" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($kecamatan as $item)
                                <tr>
                                    ...
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"  id="belum_kawin{{$number}}" name="belum_kawin[{{$item->id}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"  id="kawin{{$number}}" name="kawin[{{$item->id}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;"  id="cerai_hidup{{$number}}" name="cerai_hidup[{{$item->id}}]" value="0"></td>
                                    <td class="text-center"><input type="text" class="form-control text-center" style="width:100px;" name="cerai_mati[{{$item->id}}]" value="0"></td>
