    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('politik-pelayanan.update', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    @method('put')
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control" name="penanganan[]" value="{{ $item->penanganan }}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control" name="penegakan[]" value="{{ $item->penegakan }}" required>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
