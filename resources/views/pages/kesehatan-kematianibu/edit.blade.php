            ...
            <div class="content-group">
                <div class="page-header page-header-default" style="border: 1px solid #ddd; border-bottom: 0;">
                    ...
                    <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
                        ...
                        <a href="{{route('kematian-ibu.index',[$id_kategori,$tahun])}}" class="btn btn-xs btn-primary pull-right" style="margin-top:5px;"><i class="icon-arrow-left52"></i> Kembali</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kematian-ibu.update', array($kategori->id,$tahun)) }}" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"> 
                                    <input type="text" class="form-control text-center persen" id="persentase_{{$x}}" readonly name="persentase[{{$key}}]" value="{{isset($data[$key]['persentase']) ? number_format($data[$key]['persentase'],2,',','.') : 0}}">    
                                </td>
                            </tr>
                            @php
                                $x++;
