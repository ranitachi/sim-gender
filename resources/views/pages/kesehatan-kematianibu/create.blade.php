    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kematian-ibu.store', array($kategori->id,$tahun)) }}" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"> 
                                    <input type="text" class="form-control text-center persen" id="persentase_{{$x}}" readonly name="persentase[{{$key}}]" value="0">    
                                </td>
                            </tr>
                            @php
                                $x++;
