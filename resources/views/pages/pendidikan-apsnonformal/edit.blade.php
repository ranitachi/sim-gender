            ...
            <div class="content-group">
                <div class="page-header page-header-default" style="border: 1px solid #ddd; border-bottom: 0;">
                    ...
                    <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
                        ...
                        <a href="{{route('aps-formalnon.index',[$id_kategori,$tahun])}}" class="btn btn-xs btn-primary pull-right" style="margin-top:5px;"><i class="icon-arrow-left52"></i> Kembali</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('aps-formalnon.update', array($kategori->id,$tahun)) }}" method="post">
                    @csrf
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                @foreach ($kelompok_usia as $idx=>$item)
                        ...
                        <tbody>
                            <tr>
                                <th colspan="{{(count($kelompok_usia) + 1)}}"><b>Jenis Kelamin</b></th>
                            </tr>
                            <tr>
                                <td class="text-right">Laki Laki</td>
                                @foreach ($kelompok_usia as $idx_jen=>$item)
                            ...
                            <tr>
                                <th colspan="{{(count($kelompok_usia) + 1)}}"><b>Kuantal Pengeluaran</b></th>
                            </tr>
                            @for ($i = 1; $i <= 5; $i++)
                                <tr>
