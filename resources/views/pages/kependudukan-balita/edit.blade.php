    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form action="{{ route('kependudukan-balita.update', [$kategori->id, $tahun]) }}" method="post">
                    @csrf
                    @method('put')
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min="0" class="form-control" name="balita_l[]" value="{{ $item->balita_l }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="balita_p[]" value="{{ $item->balita_p }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="terlantar_l[]" value="{{ $item->terlantar_l }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="terlantar_p[]" value="{{ $item->terlantar_p }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="bermasalah_l[]" value="{{ $item->bermasalah_l }}" required>
                                        </td>
                                        <td>
                                            <input type="number" min="0" class="form-control" name="bermasalah_p[]" value="{{ $item->bermasalah_p }}" required>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
