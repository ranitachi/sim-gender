...
class CreateKesehatanPenolongPersalinansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kesehatan_penolong_persalinan', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('kesehatan_penolong_persalinan');
    }
}
