...
class CreatePendidikanApmFormalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pendidikan_apm_formal', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pendidikan_apm_formal');
    }
}
