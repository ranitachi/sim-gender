...
class CreatePendidikanStatusPendidikansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pendidikan_status_pendidikan', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pendidikan_status_pendidikan');
    }
}
