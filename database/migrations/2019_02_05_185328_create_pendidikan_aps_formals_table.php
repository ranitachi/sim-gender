...
class CreatePendidikanApsFormalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pendidikan_aps_formal', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pendidikan_aps_formal');
    }
}
