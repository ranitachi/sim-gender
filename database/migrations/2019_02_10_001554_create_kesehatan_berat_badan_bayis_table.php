...
class CreateKesehatanBeratBadanBayisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kesehatan_berat_badan_bayi', function (Blueprint $table) {
             $table->increments('id');
    ...
    {
        Schema::dropIfExists('kesehatan_berat_badan_bayi');
    }
}
