...
class CreateKesehatanSakitRatasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kesehatan_sakit_rata', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('kesehatan_sakit_rata');
    }
}
