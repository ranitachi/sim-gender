...
class CreateKesehatanBalitaAsiRataratasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kesehatan_balita_asi_ratarata', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('kesehatan_balita_asi_ratarata');
    }
}
