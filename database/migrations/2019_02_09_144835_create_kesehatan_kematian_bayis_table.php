...
class CreateKesehatanKematianBayisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kesehatan_kematian_bayi', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('kesehatan_kematian_bayi');
    }
}
