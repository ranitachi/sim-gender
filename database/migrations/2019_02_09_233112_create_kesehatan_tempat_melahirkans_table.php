...
class CreateKesehatanTempatMelahirkansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kesehatan_tempat_melahirkan', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('kesehatan_tempat_melahirkan');
    }
}
