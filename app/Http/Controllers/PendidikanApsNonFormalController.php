...
use App\Models\PendidikanApsNonFormal;
use Config;

class PendidikanApsNonFormalController extends Controller
{
    public function index($id_kategori,$tahun=null)
    {
        ...
        $jumlah = PendidikanApsNonFormal::where('id_kategori', $id_kategori)->where('tahun',$tahun)->get();
        ...
        $chart_tpt = array();
        // return $data;
        return view('pages.pendidikan-apsnonformal.index')
    ...
    public function create($id_kategori,$tahun)
    {
        ...
        return view('pages.pendidikan-apsnonformal.create')
            ->with('kecamatan', $kecamatan)
            ->with('kategori', $kategori)
            ->with('kelompok_usia', $kelompok_usia)
            ->with('id_kategori', $id_kategori)
    ...
    public function store(Request $request,$id_kategori,$tahun)
    {
        ...
        {
            $ins=new PendidikanApsNonFormal;
        ...
        return redirect()->route('aps-formalnon.index',[$id_kategori,$tahun])->with('Data Berhasil Disimpan');
    }
    ...
    public function edit($id_kategori,$tahun)
    {
        ...
        return view('pages.pendidikan-apsnonformal.edit')
            ->with('kecamatan', $kecamatan)
            ->with('kategori', $kategori)
            ->with('data', $data)
            ->with('kelompok_usia', $kelompok_usia)
    ...
    {
        // return $request->all();
        PendidikanApsNonFormal::where('id_kategori',$id_kategori)->where('tahun',$tahun)->forceDelete();
        ...
        return redirect()->route('aps-formalnon.index',[$id_kategori,$tahun])->with('Data  Berhasil Diperbaharui');
    }
}
