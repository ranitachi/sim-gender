...
use App\Models\KesehatanSakitRata;
use Config;
class KesehatanSakitRataController extends Controller
{
    public function index($id_kategori,$tahun=null)
    {
        ...
        $jumlah = KesehatanSakitRata::where('id_kategori', $id_kategori)->where('tahun',$tahun)->get();

        $jenis=Config::get('services.jenis_sakit_rata');
        ...
        $chart_tpt = array();
        // return $data;
        return view('pages.kesehatan-sakitrata.index')
    ...
    public function create($id_kategori,$tahun)
    {
        ...
        return view('pages.kesehatan-sakitrata.create')
            ->with('kecamatan', $kecamatan)
            ->with('kategori', $kategori)
            ->with('jenis', $jenis)
            ->with('id_kategori', $id_kategori)
    ...
    public function store(Request $request,$id_kategori,$tahun)
    {
        ...
        return redirect()->route('sakit-rata-rata.index',[$id_kategori,$tahun])->with('Data Berhasil Disimpan');
    }
    ...
    public function edit($id_kategori,$tahun)
    {
        ...
        return view('pages.kesehatan-sakitrata.edit')
            ->with('kecamatan', $kecamatan)
            ->with('kategori', $kategori)
            ->with('data', $data)
            ->with('jenis', $jenis)
    ...
    {
        // return $request->all();
        KesehatanSakitRata::where('id_kategori',$id_kategori)->where('tahun',$tahun)->forceDelete();
        ...
        return redirect()->route('sakit-rata-rata.index',[$id_kategori,$tahun])->with('Data  Berhasil Diperbaharui');
    }
}
