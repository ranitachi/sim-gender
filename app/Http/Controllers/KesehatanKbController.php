...
use App\Models\KesehatanKb;
use Config;

class KesehatanKbController extends Controller
{
    public function index($id_kategori,$tahun=null)
    {
        ...
        $jumlah = KesehatanKb::where('id_kategori', $id_kategori)->where('tahun',$tahun)->get();

        $jenis=['pernah'=>'Pernah Menggunakan','sedang'=>'Sedang Menggunakan','tidak'=>'Tidak Pernah Menggunakan'];
        ...
        $chart_tpt = array();
        // return $data;
        return view('pages.kesehatan-kb.index')
    ...
    public function create($id_kategori,$tahun)
    {
        ...
        return view('pages.kesehatan-kb.create')
            ->with('krt', $krt)
            ->with('kecamatan', $kecamatan)
            ->with('kategori', $kategori)
            ->with('jenis', $jenis)
    ...
    public function store(Request $request,$id_kategori,$tahun)
    {
        ...
        return redirect()->route('kb.index',[$id_kategori,$tahun])->with('Data Berhasil Disimpan');
    }
    ...
    public function edit($id_kategori,$tahun)
    {
        ...
        return view('pages.kesehatan-kb.edit')
            ->with('kecamatan', $kecamatan)
            ->with('krt', $krt)
            ->with('kategori', $kategori)
            ->with('data', $data)
    ...
    {
        // return $request->all();
        KesehatanKb::where('id_kategori',$id_kategori)->where('tahun',$tahun)->forceDelete();
        ...
        return redirect()->route('kb.index',[$id_kategori,$tahun])->with('Data  Berhasil Diperbaharui');
    }
}
