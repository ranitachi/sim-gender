...
use App\Models\KesehatanJenisAlatKb;
use Config;

class KesehatanJenisAlatKbController extends Controller
{
    public function index($id_kategori,$tahun=null)
    {
        ...
        $jumlah = KesehatanJenisAlatKb::where('id_kategori', $id_kategori)->where('tahun',$tahun)->get();

        $jenis=['mkjp'=>'Modern<br>MKJP','non_mkjp'=>'Modern<br>Non MKJP','tradisiona'=>'Cara Tradisional'];
        ...
        $chart_tpt = array();
        // return $data;
        return view('pages.kesehatan-jenisalatkb.index')
    ...
    public function create($id_kategori,$tahun)
    {
        ...
        return view('pages.kesehatan-jenisalatkb.create')
            ->with('krt', $krt)
            ->with('kecamatan', $kecamatan)
            ->with('kategori', $kategori)
            ->with('jenis', $jenis)
    ...
    public function store(Request $request,$id_kategori,$tahun)
    {
        ...
        return redirect()->route('jenis-alat-kb.index',[$id_kategori,$tahun])->with('Data Berhasil Disimpan');
    }
    ...
    public function edit($id_kategori,$tahun)
    {
        ...
        return view('pages.kesehatan-jenisalatkb.edit')
            ->with('kecamatan', $kecamatan)
            ->with('krt', $krt)
            ->with('kategori', $kategori)
            ->with('data', $data)
    ...
    {
        // return $request->all();
        KesehatanJenisAlatKb::where('id_kategori',$id_kategori)->where('tahun',$tahun)->forceDelete();
        ...
        return redirect()->route('jenis-alat-kb.index',[$id_kategori,$tahun])->with('Data  Berhasil Diperbaharui');
    }
}
