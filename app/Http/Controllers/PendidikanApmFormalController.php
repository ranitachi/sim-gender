...
use App\Models\PendidikanApmFormal;
use Config;

class PendidikanApmFormalController extends Controller
{
    public function index($id_kategori,$tahun=null)
    {
        ...
        $jumlah = PendidikanApmFormal::where('id_kategori', $id_kategori)->where('tahun',$tahun)->get();
        ...
        $chart_tpt = array();
        // return $data;
        return view('pages.pendidikan-apmformal.index')
    ...
    public function create($id_kategori,$tahun)
    {
        ...
        return view('pages.pendidikan-apmformal.create')
            ->with('kecamatan', $kecamatan)
            ->with('kategori', $kategori)
            ->with('jenjang', $jenjang)
            ->with('id_kategori', $id_kategori)
    ...
    public function store(Request $request,$id_kategori,$tahun)
    {
        ...
        return redirect()->route('apm-formal.index',[$id_kategori,$tahun])->with('Data Berhasil Disimpan');
    }
    ...
    public function edit($id_kategori,$tahun)
    {
        ...
        return view('pages.pendidikan-apmformal.edit')
            ->with('kecamatan', $kecamatan)
            ->with('kategori', $kategori)
            ->with('data', $data)
            ->with('jenjang', $jenjang)
    ...
    {
        // return $request->all();
        PendidikanApmFormal::where('id_kategori',$id_kategori)->where('tahun',$tahun)->forceDelete();
        ...
        return redirect()->route('apm-formal.index',[$id_kategori,$tahun])->with('Data  Berhasil Diperbaharui');
    }
}
